...
const v5 = {
  ...
  /**
   * Search v5 media library for an existing file by name to avoid duplicate registrations.
   * Media registration (URL import) is handled directly in mediaHandler.js via axios,
   * because Strapi v5 handles the S3 fetch itself — no manual upload needed.
   */
